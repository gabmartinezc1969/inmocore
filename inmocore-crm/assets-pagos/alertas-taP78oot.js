import{u as l}from"./pagos-ByLpTsXd.js";function t(){const i=l(),d=i.filter(e=>e.sev==="high").length,s=i.filter(e=>e.sev==="medium").length;document.getElementById("aleCards").innerHTML=`
